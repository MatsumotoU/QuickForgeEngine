...
QFE::EDITOR::GameViewer::GameViewer(ImTextureID sceneTextureId) :
	sceneTextureId_(sceneTextureId),
	isActive_(true) {
}

void QFE::EDITOR::GameViewer::Initialize() {
	isActive_ = true;
}

void QFE::EDITOR::GameViewer::Draw(std::set<uint32_t>& selectedEntities, EditorCommandList& commandList) {
...
std::string QFE::EDITOR::GameViewer::GetWindowName() {
	return "GameViewer";
}

bool QFE::EDITOR::GameViewer::GetIsActive() {
	return isActive_;
}

bool QFE::EDITOR::GameViewer::SetIsActive(bool isActive) {
	isActive_ = isActive;
	return isActive_;
}

bool QFE::EDITOR::GameViewer::GetIsFocus() {
	return isFocus_;
}
