...
void QFE::Render::Sprite::DrawSprites(EntityManager* entityManager, const uint32_t& spriteHandle) {
	...
	const SpriteData& spriteData = entityManager->GetComponent<SpriteData>(spriteHandle);
