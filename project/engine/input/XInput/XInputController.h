...
namespace QFE::INPUT {
	...
	public:
		...
		/// <param name="padId"></param>
		/// <returns></returns>
		bool GetTriggerButton(WORD type, uint32_t padId);
		/// <summary>
		///	XINPUT_GAMEPAD_DPAD_UP			0x0001
		///	XINPUT_GAMEPAD_DPAD_DOWN		0x0002
		///	XINPUT_GAMEPAD_DPAD_LEFT		0x0004
		...
		/// <param name="padId"></param>
		/// <returns></returns>
		bool GetReleaseButton(WORD type, uint32_t padId);

		MATH::Vector2 GetRightStick(uint32_t padId);
		MATH::Vector2 GetLeftStick(uint32_t padId);
