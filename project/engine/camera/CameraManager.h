...
namespace QFE::CAMERA {
	...
	public:
		...
		MATH::Matrix4x4 GetViewProjectionMatrix(CameraHandle handle, const MATH::Transform& cameraTranform, CameraType type);
		/// @brief あるカメラのWVP行列を取得します
		MATH::Matrix4x4 GetWVPMatrix(CameraHandle handle, const MATH::Matrix4x4& worldMatrix, const MATH::Transform& cameraTranform, CameraType type);
