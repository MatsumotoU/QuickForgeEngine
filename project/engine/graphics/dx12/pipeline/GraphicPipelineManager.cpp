...
void GraphicPipelineManager::Initialize(
	ID3D12Device* device, const D3D12_DEPTH_STENCIL_DESC& depthStencilDesc) {
	...
	for (int i = 0; i < kCountOfBlendMode; i++) {
		...
		trianglePso_[i].CreatePipelineStateObject(
			normalGameObjectRootParameter_, depthStencilDesc, normalInputLayout_,
		...
		spritePso_[i].CreatePipelineStateObject(
			spriteObjectRootParameter_, depthStencilDesc, normalInputLayout_,
		...
		linePso_[i].CreatePipelineStateObject(
			primitiveRootParameter_, depthStencilDesc, primitiveInputLayout_,
		...
		particlePso_[i].CreatePipelineStateObject(
			particleRootParameter_, depthStencilDesc, normalInputLayout_,
	...
	colorCorrectionPso_.CreatePipelineStateObject(
		colorCorrectionRootParameter_, depthStencilDesc, normalInputLayout_,
	...
	grayScaleTrianglePso_.CreatePipelineStateObject(
		grayScaleRootParameter_, depthStencilDesc, normalInputLayout_,
	...
	boxFilterPso_.CreatePipelineStateObject(
		boxFilterRootParameter_, depthStencilDesc, normalInputLayout_,
	...
	vignettePso_.CreatePipelineStateObject(
		vignetteRootParameter_, depthStencilDesc, normalInputLayout_,
	...
	pixelPso_.CreatePipelineStateObject(
		pixelRootParameter_, depthStencilDesc, normalInputLayout_,
	...
	fontPso_.CreatePipelineStateObject(
		fontRootParameter_, depthStencilDesc, primitiveInputLayout_,
	...
	D3D12_DEPTH_STENCIL_DESC skyboxDepthStencilDesc = depthStencilDesc;
